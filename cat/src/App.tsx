    ...
    <div className="page">
      <header className="topbar">
        <div>
          ...
          <div className="title-row">
            <h1>Consultant Attending Table</h1>
            <a
            ...
            <a
              className="title-link"
              href="https://kwtsang101016.github.io/activities/consult2027/calendar/"
              target="_blank"
              rel="noreferrer"
            >
              Calendar
          ...
          <p className="subtitle">
            曾家炜 · Ka Wai Tsang · Statistics consultation · {roster.classroom}
          </p>
        </div>
      ...
      {selectedPerson ? (
        ...
        <p className="howto">
          ...
          IDs are never shown on the board. Name cards list school, major, and year.
