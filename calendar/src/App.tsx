  ...
  return (
    <div className="page calendar-page">
      <header className="cal-hero">
        <p className="eyebrow">CUHK(SZ) · Statistics Consultation · 2026–27</p>
        <div className="title-row">
          <h1>Consultation Calendar</h1>
          <a
            className="title-link"
            href="https://kwtsang101016.github.io/activities/consult2027/"
            target="_blank"
            rel="noreferrer"
          >
            Project page
          ...
          <a
            className="title-link"
            href="https://kwtsang101016.github.io/vibe_coding_slides/"
            target="_blank"
            rel="noreferrer"
          >
            Vibe coding
          ...
          <a
            className="title-link"
            href="https://consult2027-cat.onrender.com/"
            target="_blank"
            rel="noreferrer"
          >
            CAT
        ...
        <p className="lead">
          Tentative dates for vibe-coding workshops, consultation sessions, and FAQ workshops.
          Click a marked day for details. Days with a saved CAT attendance snapshot open the seating
          board (read-only).
        </p>
      </header>
          ...
          <ul className="day-panel__list">
            {view.events.map((event) => (
              <li
                ...
                className={
                  event.special ? "day-panel__item day-panel__item--special" : "day-panel__item"
                }
              >
